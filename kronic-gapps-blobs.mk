...
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,vendor/kronicgapps/lib,system/lib)
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,vendor/kronicgapps/lib64,system/lib64)
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,vendor/kronicgapps/usr,system/usr)
...
PRODUCT_COPY_FILES += \
    ...
    vendor/kronicgapps/etc/permissions/privapp-permissions-google.xml:system/etc/permissions/privapp-permissions-google.xml \
    vendor/kronicgapps/etc/preferred-apps/google.xml:system/etc/preferred-apps/google.xml \
    vendor/kronicgapps/etc/sysconfig/framework-sysconfig.xml:system/etc/sysconfig/framework-sysconfig.xml \
    ...
    vendor/kronicgapps/etc/sysconfig/google-hiddenapi-package-whitelist.xml:system/etc/sysconfig/google-hiddenapi-package-whitelist.xml \
    vendor/kronicgapps/etc/sysconfig/google_vr_build.xml:system/etc/sysconfig/google_vr_build.xml \
    vendor/kronicgapps/etc/sysconfig/hiddenapi-package-whitelist.xml:system/etc/sysconfig/hiddenapi-package-whitelist.xml \
